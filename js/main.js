/*! restsecinc - v1.0.0 - 2017-01-16 */(function() {
  $(function() {
    $('.slider1').bxSlider({
      minSlides: 3,
      maxSlides: 3,
      ...
      items: [
        {
          ...
          fullContent: '<div class=""> <i class="col-md-2 fa fa-flag fa-2x" style="color: #c59a6d"></i> <div class="col-md-10"> <h3 style="color: #c59a6d">The Beginning</h3> <p>Quisque ut convallis diam, id pulvinar leo. Integer consequat vulputate orci sit amet consequat</p> </div> </div>'
        }, {
          type: 'smallItem',
          label: '2007',
          showMore: 'show more',
          ...
          fullContent: '<div class=""> <i class="col-md-2 fa fa-trophy fa-2x" style="color: #c59a6d"></i><div class="col-md-10"> <h3 style="color: #c59a6d">The First Award</h3> <p>Quisque ut convallis diam, id pulvinar leo. Integer consequat vulputate orci sit amet consequat</p> </div> </div>'
        }, {
          type: 'smallItem',
          label: '2008',
          showMore: 'show more',
          ...
          fullContent: '<div class=""> <i class="col-md-2 fa fa-building fa-2x" style="color: #c59a6d"></i> <div class="col-md-10"> <h3 style="color: #c59a6d">We Have A new Office</h3> <p>Quisque ut convallis diam, id pulvinar leo. Integer consequat vulputate orci sit amet consequat</p> </div> </div>'
        }
      ]
    });
  });
